<h1>Konichivaa 🌸, I'm Laya</h1>
<p>Dipping my hands into every bucket—maybe, maybe not, but definitely curious!</p>
<p>I'm all about building impactful digital experiences—from web apps and e-commerce platforms to cybersecurity experiments and gamified wellness trackers. Whether it's through clean UI/UX, powerful backend logic, or research-driven development, I love bringing ideas to life.
</p>
...
<h2>🛠️ Some Cool Tools I’ve Built</h2>
<table border="1">
  <tr>
    <th>Project</th>
    <th>Description</th>
  ...
  <tr>
    <td>Painting Inventory System</td>
    <td>Google Sheets + Drive automation to manage art listings with pricing, framing, and availability</td>
    <td>Google Apps Script, Sheets</td>
  </tr>
  <tr>
    <td>Expense Tracker App</td>
    <td>Tracks budgeted vs. used money across multiple categories</td>
    <td>React, Django, Firebase</td>
  </tr>
   <tr>
    <td>Painting Inventory System using Streamlit</td>
    <td>Streamlit app to make descriptions for art and make a pdf out of it </td>
    <td>Streamlit,Openai</td>
  </tr>
